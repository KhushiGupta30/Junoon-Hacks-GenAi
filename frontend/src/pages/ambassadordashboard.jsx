...
const AmbassadorDashboardPage = () => {
  ...
  const statsData = [
    { label: 'Artisans Mentored', value: stats?.mentored ?? 0, icon: <UsersIcon />, color: 'google-blue', borderColor: 'border-google-blue', bgColor: 'bg-google-blue', link: '#/ambassador/artisans', description: "View your artisan network" },
    { label: 'Events Hosted', value: stats?.events ?? 0, icon: <CalendarIcon />, color: 'google-green', borderColor: 'border-google-green', bgColor: 'bg-google-green', link: '#/ambassador/events', description: "Manage and plan events" },
    { label: 'Your Impact Score', value: stats?.impactScore.toLocaleString() ?? 0, icon: <SparklesIcon />, color: 'google-yellow', borderColor: 'border-google-yellow', bgColor: 'bg-google-yellow', link: '#', description: "See the difference you're making" },
  ];
