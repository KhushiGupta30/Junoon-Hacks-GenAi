    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-1 text-xs text-gray-500">
          This information will be used for your account and profile.
        </p>
      </div>
        ...
        <div className="relative">
          <img
            src={
              ...
              "https://placehold.co/96x96/E8F0FE/4285F4?text=I&font=roboto"
            }
            alt="Profile"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <FormInput
          ...
          id="contact"
          type="tel"
          value={investorData.contact}
          onChange={(e) =>
            setInvestorData({ ...investorData, contact: e.target.value })
          }
      ...
      <div>
        ...
        <textarea
          ...
          placeholder="Tell artisans about your investment interests, background, or what you look for..."
        ></textarea>
      </div>
    </div>
  );
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-1 text-xs text-gray-500">
          Help us match you with the right artisans and opportunities.
        </p>
      </div>
      <div className="space-y-6 pt-4 border-t border-gray-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <FormSelect
            label="Interested Crafts (Primary)"
            id="interestedCrafts"
            value={investorData.interestedCrafts}
            onChange={(e) =>
              setInvestorData({
                ...investorData,
                interestedCrafts: e.target.value,
              })
            }
          >
          ...
          <FormSelect
            ...
            value={investorData.typicalInvestmentRange}
            onChange={(e) =>
              setInvestorData({
                ...investorData,
                typicalInvestmentRange: e.target.value,
              })
            }
          >
        ...
        <div>
          ...
          <textarea
            id="investmentGoals"
            rows="4"
            value={investorData.investmentGoals}
            onChange={(e) =>
              setInvestorData({
                ...investorData,
            ...
            className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-google-blue focus:border-google-blue sm:text-sm"
            placeholder="e.g., Supporting sustainable crafts, long-term growth, community impact..."
          ></textarea>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-1 text-xs text-gray-500">
          This is where your investment returns will be sent. This information
          is kept private.
        </p>
      </div>
      <div className="p-4 bg-yellow-50/70 border border-yellow-200 rounded-lg flex items-start gap-3">
        ...
        <p className="text-xs text-yellow-800">
          For security, billing details can only be changed by contacting
          support after they have been verified.
        </p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <FormInput
          label="Bank Name"
          id="bankName"
          value={investorData.bankName}
          onChange={(e) =>
            setInvestorData({ ...investorData, bankName: e.target.value })
          }
        />
        <FormInput
          label="Account Holder Name"
          id="accountHolder"
          value={investorData.accountHolder}
          onChange={(e) =>
            setInvestorData({ ...investorData, accountHolder: e.target.value })
          }
        />
        <FormInput
          label="Account Number"
          id="accountNumber"
          value={investorData.accountNumber}
          onChange={(e) =>
            setInvestorData({ ...investorData, accountNumber: e.target.value })
          }
        />
        <FormInput
          label="IFSC / Routing Code"
          id="ifscCode"
          value={investorData.ifscCode}
          onChange={(e) =>
            setInvestorData({ ...investorData, ifscCode: e.target.value })
          }
        />
      </div>
    </div>
