    ...
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-lg p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <input
            type="text"
            placeholder="Location (e.g., City Hall)"
            value={location}
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        ...
        {user.role === "ambassador" && (
          <button
            ...
            className="flex items-center bg-blue-600 text-white font-semibold px-4 py-2 rounded-lg shadow hover:bg-blue-700 transition"
          >
      ...
      <p className="text-gray-600 mb-8">
        Upcoming events, workshops, and meetups organized by our ambassadors.
      </p>
                ...
                !event.attendees?.includes(user.id) && (
                  <div className="mt-4">
                    <button
                      ...
                      className="bg-green-500 text-white font-semibold px-4 py-2 rounded-md text-sm hover:bg-green-600 transition"
                    >
                      Join Event
                    </button>
                  </div>
