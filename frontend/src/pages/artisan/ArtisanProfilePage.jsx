  ...
  <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 p-6 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-100">
    <img
      src={
        ...
        "https://placehold.co/128x128/E8F0FE/4285F4?text=A&font=roboto"
      }
      alt={artisan.name}
    ...
    <div className="text-center sm:text-left">
      ...
      <p className="text-sm font-medium text-google-blue mt-1">
        {artisan.artisanProfile?.craftSpecialty?.join(", ") || "Artisan"}
      </p>
      {artisan.profile?.location && (
        <p className="text-xs text-gray-500 mt-1">
          {artisan.profile.location.city}, {artisan.profile.location.state}
        </p>
      )}
      <p className="text-sm text-gray-600 mt-3">
        {artisan.profile?.bio || "No bio available."}
      </p>
    </div>
  </div>
);
        ...
        {products.map((product) => (
          ...
          >
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden group-hover:shadow-md transition-shadow">
              ...
              />
              <div className="p-3">
                <p className="text-sm font-medium text-gray-800 truncate group-hover:text-google-blue">
                  {product.name}
                </p>
                <p className="text-xs text-google-green font-semibold mt-1">
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-1 text-xs text-gray-500">
          This information will be displayed on your artisan shop page.
        </p>
      </div>
      ...
      <div className="flex items-center gap-5">
        <div className="relative">
          <img
            src={
              artisanData.profilePicture ||
              "https://placehold.co/96x96/E8F0FE/4285F4?text=A&font=roboto"
            }
            alt="Profile"
        ...
        <div className="flex-1">
          <FormInput
            ...
            onChange={(e) =>
              setArtisanData({ ...artisanData, studioName: e.target.value })
            }
            placeholder="e.g., Khushi's Creations"
          />
        </div>
      </div>
      ...
      <div>
        ...
        <textarea
          ...
          onChange={(e) =>
            setArtisanData({ ...artisanData, bio: e.target.value })
          }
          className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-google-blue focus:border-google-blue sm:text-sm"
          placeholder="Tell buyers about your craft, inspiration, and what makes your work unique..."
        ></textarea>
      </div>
    </div>
  );
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-1 text-xs text-gray-500">
          Provide details about you and your business operations.
        </p>
      </div>
      <div className="space-y-6 pt-4 border-t border-gray-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <FormInput
            label="Artisan Name"
            id="artisanName"
            value={artisanData.artisanName}
            onChange={(e) =>
              setArtisanData({ ...artisanData, artisanName: e.target.value })
            }
          ...
          <FormInput
            ...
            onChange={(e) =>
              setArtisanData({ ...artisanData, contact: e.target.value })
            }
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <FormInput
            ...
            onChange={(e) =>
              setArtisanData({ ...artisanData, city: e.target.value })
            }
          ...
          <FormInput
            label="State"
            id="state"
            value={artisanData.state}
            onChange={(e) =>
              setArtisanData({ ...artisanData, state: e.target.value })
            }
          ...
          <FormInput
            label="Pincode"
            id="pincode"
            value={artisanData.pincode}
            onChange={(e) =>
              setArtisanData({ ...artisanData, pincode: e.target.value })
            }
      ...
      <div className="space-y-6 pt-4 border-t border-gray-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <FormSelect
            ...
            id="speciality"
            value={artisanData.speciality}
            onChange={(e) =>
              setArtisanData({ ...artisanData, speciality: e.target.value })
            }
          >
          ...
          <FormSelect
            ...
            id="workingStatus"
            value={artisanData.workingStatus}
            onChange={(e) =>
              setArtisanData({ ...artisanData, workingStatus: e.target.value })
            }
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <FormInput
            ...
            id="teamMembers"
            type="number"
            value={artisanData.teamMembers}
            onChange={(e) =>
              setArtisanData({ ...artisanData, teamMembers: e.target.value })
            }
            min="1"
            placeholder="e.g., 3"
          />
          <FormSelect
            ...
            value={artisanData.languagePreference}
            onChange={(e) =>
              setArtisanData({
                ...artisanData,
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-1 text-xs text-gray-500">
          This is where your earnings will be sent. This information is kept
          private.
        </p>
      </div>
      <div className="p-4 bg-yellow-50/70 border border-yellow-200 rounded-lg flex items-start gap-3">
        ...
        <p className="text-xs text-yellow-800">
          For security, payout details can only be changed by contacting support
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <FormInput
          ...
          onChange={(e) =>
            setArtisanData({ ...artisanData, bankName: e.target.value })
          }
        />
        <FormInput
          label="Account Holder Name"
          id="accountHolder"
          value={artisanData.accountHolder}
          onChange={(e) =>
            setArtisanData({ ...artisanData, accountHolder: e.target.value })
          }
        />
        <FormInput
          label="Account Number"
          id="accountNumber"
          value={artisanData.accountNumber}
          onChange={(e) =>
            setArtisanData({ ...artisanData, accountNumber: e.target.value })
          }
        />
        <FormInput
          label="IFSC / Routing Code"
          id="ifscCode"
          value={artisanData.ifscCode}
          onChange={(e) =>
            setArtisanData({ ...artisanData, ifscCode: e.target.value })
          }
        />
      </div>
    </div>
