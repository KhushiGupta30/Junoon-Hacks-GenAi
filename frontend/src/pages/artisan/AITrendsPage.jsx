...
const SkeletonChartCard = () => <SkeletonBase className="h-64 md:h-80" />;
...
const TrendDetailModal = ({ trend, onClose }) => {
  ...
  return (
    ...
    >
      <div
        className={`relative bg-white w-full max-w-lg rounded-xl shadow-xl p-6 md:p-8 transform transition-all duration-300 ${
      ...
      >
        ...
        <div className="flex flex-wrap justify-center gap-2">
          {trend.keywords.map((kw, idx) => (
            <span
              key={idx}
              className="text-xs font-medium bg-gray-100 text-gray-700 px-2.5 py-1 rounded-full border border-gray-200"
            >
              {kw}
            </span>
          ))}
          ...
          <AnimatedSection>
            ...
            <div className="bg-yellow-50/60 p-5 rounded-xl border border-yellow-200/80 text-center">
              <div className="inline-flex items-center gap-2 mb-2 bg-yellow-100/70 px-3 py-1 rounded-full">
                ...
                <h3 className="text-xs font-semibold text-yellow-800 uppercase tracking-wider">
                  Trend of the Month
                </h3>
              </div>
              <p className="text-lg font-semibold text-gray-800 mt-1 mb-3">
                {trends.trendOfMonth.title}
              </p>
              <button
          ...
          <AnimatedSection>
            <div className="bg-white rounded-xl shadow-sm border border-gray-200">
              ...
              <div className="divide-y divide-gray-100 max-h-96 overflow-y-auto">
                {" "}
                {}
                {trends.actionableTips.length > 0 ? (
