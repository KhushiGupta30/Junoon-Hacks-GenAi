...
import { ChatAlt2Icon, PlusIcon } from '../../components/common/Icons';
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center pt-8 mb-6">
        ...
        <Link to="/artisan/community" className="text-google-blue hover:underline">Back to Community</Link>
      </div>
      ...
      <div className="space-y-4">
        {discussions.map(discussion => (
          <div key={discussion._id} className="bg-white p-4 rounded-lg shadow-md hover:shadow-lg transition-shadow">
            <Link to={`/artisan/discussions/${discussion._id}`}>
              <h3 className="text-lg font-semibold text-google-blue">{discussion.title}</h3>
