...
// --- Animation Variants ---
const containerVariants = { // For staggering children
    hidden: { opacity: 0 },
    visible: {
        opacity: 1,
        transition: {
...
const itemVariants = { // For items in the staggered container
    hidden: { opacity: 0, y: 20 },
    visible: { opacity: 1, y: 0, transition: { duration: 0.4, ease: "easeOut" } }
};

// (Note: headerInfoVariants is no longer used in your new header, which is fine)
...
const SellerPage = () => {
    ...
    useEffect(() => {
        const fetchArtisanData = async () => {
            ...
            setError(null);
            try {
                // Assuming the API returns the full artisan profile, including artisanProfile.story
        ...
        return (
            <div className="pt-24 pb-12 text-center container mx-auto px-6">
                ...
                <div className="flex justify-center items-center mt-4">
                    ...
                    <p className="text-gray-600 text-lg ml-3">Loading Artisan Profile...</p>
                </div>
            </div>
        );
    }
        ...
        return (
            <div className="pt-24 pb-12 text-center container mx-auto px-6">
                 ...
                 <div className="bg-white p-8 rounded-lg shadow-md max-w-lg mx-auto">
                    ...
                    <p className="text-gray-600 mt-2">{error || "The requested artisan could not be found."}</p>
    ...
    return (
        <>
            {/* --- Header with Animated Artisan Info --- */}
            {/* ADDED z-0 here to ensure correct stacking */}
            <div
            ...
            >
              <div className="absolute inset-0 bg-black/60 flex items-center">
                <div className="container mx-auto px-6">
                  ...
                  >
                    {/* Profile + Info Slide from Center to Left */}
                    <motion.div
                    ...
                    >
                      <motion.img
                        ...
                        src={
                          ...
                          `https://ui-avatars.com/api/?name=${artisan.name.replace(
                            /\s/g,
                            "+"
                      ...
                      <div className="text-white">
                        <h1 className="text-3xl md:text-4xl font-bold">{artisan.name}</h1>
                    ...
                    {/* Story Reveal (fades in as profile moves) */}
                    <motion.div
            ...
            {/* --- Main Content Area (Staggered Animation) --- */}
            {/* RE-ADDED this wrapper for correct layout and overlap */}
            <motion.div
            ...
            >
                <div className="container mx-auto px-6 pt-12">
                    ...
                    <motion.div variants={itemVariants} className="mb-6">
                         <h2 className="text-2xl font-bold text-gray-800">Products by {artisan.name}</h2>
                    </motion.div>

                    {products && products.length > 0 ? (
                        <motion.div
                            className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-6"
                            // This container staggers the cards
                            variants={containerVariants}
                        >
                        ...
                        <motion.p variants={itemVariants} className="text-center text-gray-500 py-8">
                            This artisan has not listed any products yet.
                        </motion.p>
                    )}
                </div>
            </motion.div>
            {/* Removed the extra </div> tags that were here */}
            ...
            <InvestmentModal
                ...
                artisanId={artisanId}
                artisanName={artisan?.name} // Use optional chaining just in case
