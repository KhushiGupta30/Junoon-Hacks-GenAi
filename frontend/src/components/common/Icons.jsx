...
export const MoneyIcon = ({ className = "w-6 h-6" }) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M12 8c-2.5 0-4.5 1.8-4.5 4s2 4 4.5 4 4.5-1.8 4.5-4m0 0V4m0 8v8"
    />
  </svg>
);
...
export const TruckIcon = ({ className = "w-6 h-6" }) => (
  ...
  >
    ...
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M13 16h2a1 1 0 001-1V7.5a2.5 2.5 0 015 0V16a1 1 0 01-1 1h-2.5"
    />
  </svg>
);
...
export const ProductsIcon = ({ className = "w-6 h-6" }) => (
  ...
  >
    ...
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M17 17h.01M17 13h5a2 2 0 012 2v5a2 2 0 01-2 2h-5a2 2 0 01-2-2v-5a2 2 0 012-2z"
    />
  </svg>
);
...
export const CurrencyDollarIcon = ({ className = "w-6 h-6" }) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0c-1.11 0-2.08-.402-2.599-1M15 9.599C15.325 9.223 15 8.79 15 8.79m-6 0c.325.433.649.866.974 1.301M9 9.599C8.675 9.223 9 8.79 9 8.79M12 21a9 9 0 100-18 9 9 0 000 18z"
    />
  </svg>
);
...
export const ShieldCheckIcon = ({ className = "w-6 h-6" }) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 20.417l5.5-5.5a1 1 0 011.414 0l5.5 5.5A12.02 12.02 0 0021 8.984a11.955 11.955 0 01-2.382-4.016z"
    />
  </svg>
);
...
export const PencilSquareIcon = ({ className = "w-5 h-5" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className={className}
    fill="none"
...
export const ColorSwatchIcon = ({ className = "w-6 h-6" }) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12.586a1 1 0 00.707-.293l2.414-2.414a1 1 0 00.293-.707V11.586a1 1 0 00-.293-.707l-2.414-2.414A1 1 0 0019.586 8H13V3m-3 4a1 1 0 100 2 1 1 0 000-2zm-1 5a1 1 0 100 2 1 1 0 000-2z"
    />
  </svg>
);
...
export const ExclamationTriangleIcon = ({ className = "w-6 h-6" }) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16.016c-.77 1.333.192 3 1.732 3z"
    />
  </svg>
);
...
export const CameraIcon = ({ className = "w-5 h-5" }) => (
  ...
  >
    <path
      fillRule="evenodd"
      d="M4 5a2 2 0 00-2 2v8a2 2 0 002 2h12a2 2 0 002-2V7a2 2 0 00-2-2H4zm12 12H4l4-8 3 6 2-4 3 6z"
      clipRule="evenodd"
    />
  </svg>
);
