...
import { GoogleMicIcon, XIcon } from "./common/Icons";
  ...
  useEffect(() => {
    ...
    recognition.onresult = async (event) => {
      ...
      if (event.results[0].isFinal) {
        setMessages((prev) => [
          ...prev,
          { role: "user", text: currentTranscript },
        ]);
              ...
              <div className="h-[60vh] flex flex-col">
                ...
                >
                  <AnimatePresence>
                    {messages.map((msg, index) => (
                      ...
                      >
                        <div
                          className={`p-3 rounded-xl max-w-[80%] prose prose-sm ${
                            msg.role === "user"
                              ? "bg-google-blue text-white rounded-br-none prose-invert"
                              : msg.isError
                ...
                <div className="flex flex-col items-center justify-center p-4 border-t border-gray-200 bg-white">
                  <motion.button
                    ...
                    className={`relative w-16 h-16 rounded-full flex items-center justify-center focus:outline-none focus:ring-4 focus:ring-offset-2 focus:ring-google-blue/30 disabled:opacity-50 ${
                      isListening
