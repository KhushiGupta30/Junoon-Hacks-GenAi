...
// Renamed to BulkOrder to match your import path
const BulkOrder = ({ isOpen, onClose, productId, productName }) => { 
  const [quantity, setQuantity] = useState(10); // Default bulk quantity
        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-between p-5 border-b border-gray-200">
              <h3 className="text-xl font-bold text-gray-800">Place Bulk Order</h3>
              <button
                onClick={onClose}
