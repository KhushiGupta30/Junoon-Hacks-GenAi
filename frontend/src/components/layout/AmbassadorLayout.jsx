...
const AmbassadorHeader = () => {
  ...
  return (
    <header className="main-app-headerfixed top-0 left-0 right-0 h-16 bg-white/95 backdrop-blur-sm z-50 shadow-sm border-b border-gray-200">
...
const AmbassadorLayout = () => {
  return (
    <div className="min-h-screen bg-gray-50">
      <AmbassadorHeader />
      <main className="main-page-content flex-1 overflow-y-auto pt-16 pb-8">
