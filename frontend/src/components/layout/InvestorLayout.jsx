...
const NavItem = ({ to, children }) => (
  <NavLink
    to={to}
    end={to.endsWith("dashboard")} // This correctly handles the dashboard link
    className={({ isActive }) =>
...
const InvestorHeader = () => {
    // Get all necessary context values, including notifications
    ...
    // Define investor-specific navigation links
    const navLinks = [
        { name: 'Dashboard', href: '/investor/dashboard' },
        { name: 'Browse Artisans', href: '/investor/browse-artisans' },
        { name: 'My Portfolio', href: '/investor/portfolio' },
    ];
                ...
                <div className="h-16 flex items-center justify-between px-4 sm:px-6 md:px-8">
                    <div className="flex items-center h-16">
                         <NavLink to="/investor/dashboard" className="flex items-center space-x-3 mr-8 flex-shrink-0">
                            ...
                            {/* Updated to match ArtisanHeader style */}
                        ...
                        {/* Map over navLinks array like ArtisanHeader */}
                    ...
                    <div className="flex items-center space-x-4 flex-shrink-0">
                        {/* Notification Bell (from ArtisanHeader) */}
                        ...
                        {/* Profile Dropdown (from ArtisanHeader) */}
                          ...
                          {isProfileOpen && (
                            <div className="absolute right-0 mt-3 w-64 bg-white rounded-xl shadow-2xl py-2 z-[60] border border-gray-200">
                              ...
                              <div className="flex flex-col space-y-1 mt-1 px-1">
                                {/* Updated link to investor profile */}
                                <NavLink to="/investor/profile" className="flex items-center w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 rounded-lg" onClick={() => setIsProfileOpen(false)}>
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <main className="pt-16">
                {/* --- MODIFIED LINE --- 
                    Removed "container" and "mx-auto" to make it full-width 
                */}
